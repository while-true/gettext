...
%__gettext_tools_dir%xgettext --force-po -f %__gettext_current_dir%files.txt --from-code=UTF-8 --keyword=_ --keyword=_:1,2 -L C --omit-header -o %__gettext_current_dir%messages-js.pot
